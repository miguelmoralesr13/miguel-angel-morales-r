...
const skillsData = [
  ...
  { name: 'Angular', percent: 80, color: 'from-purple-400 to-pink-500', size: 120 },
  { name: 'Vue.js', percent: 75, color: 'from-purple-400 to-pink-500', size: 120 },
  ...
  { name: 'Socket.io', percent: 90, color: 'from-purple-400 to-pink-500', size: 90 },
  ...
  { name: 'Firebase', percent: 85, color: 'from-orange-400 to-red-500', size: 85 },
  { name: 'AWS', percent: 80, color: 'from-cyan-400 to-blue-400', size: 90 },
  { name: 'GGP', percent: 70, color: 'from-cyan-400 to-blue-400', size: 70 },
  ...
  { name: 'Jenkins', percent: 85, color: 'from-red-400 to-orange-500', size: 90 },
  { name: 'SonarQube', percent: 80, color: 'from-red-400 to-orange-500', size: 85 },
  { name: 'JUnit', percent: 90, color: 'from-green-400 to-emerald-500', size: 80 },
  { name: 'Jest', percent: 95, color: 'from-green-400 to-emerald-500', size: 85 },
  { name: 'Unit Testing', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Integration Testing', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'PWA', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Material Design', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Responsive Design', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Express.js', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Git', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'GitHub', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'VS Code', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Postman', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Testing', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Documentation', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Clean Architecture', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'SOLID Principles', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Microservices', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Agile', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
  { name: 'Scrum', percent: 90, color: 'from-green-400 to-emerald-500', size: 100 },
];
